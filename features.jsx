...
.modal__panel {
  position: relative; width: min(880px, 100%); max-height: 92vh;
...
.modal__body { position: relative; z-index: 2; flex: 1; padding: clamp(22px,4vw,42px); overflow-y: auto; min-height: 320px; }
